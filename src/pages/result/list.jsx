   ...
   <Card href="#" className="max-w">
      ...
      <p className="font-normal text-gray-700 dark:text-gray-400">
      {
        data && data.map((value) =>
          ...
          <button onClick={()=> handleCopy(value.id)} type="button" className="focus:outline-none text-white bg-cyan-400 hover:bg-cyan-700 focus:ring-4 focus:ring-green-300 font-medium rounded-xl text-sm px-5 py-2.5 me-2 mb-2 ">Kopyala</button>
